  ...
  <div>
    <v-card class="card">
      <v-card-title
        ...
        "
        v-bind:style="{
            backgroundColor: city.department == 'police' ? 'var(--v-secondary-base)' :
                             city.department == 'fire' ? 'var(--v-error-base)' : 'var(--v-background-base)'
          }"
      >
        <v-row no-gutters style="width: 100%;">
          <span
            style="font-weight: bold;"
            class="headline-3 surface--text"
          >
            {{ city.city }}
          </span>
          <v-spacer />
        ...
        <v-row
          ...
          "
          v-bind:style="{
            backgroundColor: city.department == 'police' ? 'var(--v-tertiary-base)' :
      ...
      <v-card-text
        ...
        <v-row no-gutters style="width: 100%;">
          ...
          >
            ...
            <v-icon
              small
              :color="city.department == 'police' ? 'tertiary' :
                      city.department == 'fire' ? '#D56956' : 'background'"
            >
              mdi-play
            </v-icon>
          </a>
